...
def accuracy(labelcorrect, labelpred):
     """Gives the accuracy of a prediction based on a reference."""
    return round(sklearn.metrics.accuracy_score(labelcorrect, labelpred),2)


def mutual_info(labelcorrect, labelpred):
     """Gives the mutual info."""
    return round(sklearn.metrics.mutual_info_score(labelcorrect, labelpred,
                                                   contingency=None), 2)


def normmutualinfo(labelcorrect, labelpred):
     """Gives the normalized mutual info."""
...
def f_beta(labelcorrect, labelpred):
    ...
    return round(sklearn.metrics.fbeta_score(labelcorrect, labelpred,
                                             beta=0.5, labels=None,
                                             pos_label=1,
                                             average='micro'), 2)


def rand(labelcorrect,labelpred):
     """Gives the adjusted rand score."""
    return round(sklearn.metrics.adjusted_rand_score(labelcorrect,
                                                     labelpred), 2)


def precision(labelcorrect, labelpred):
     """Gives the precision score."""
    return round(sklearn.metrics.precision_score(labelcorrect,
                                                 labelpred), 2)
...
for outer in range(5):
    X_train, X_test, y_train, y_test = cross_validation.train_test_split(
         X_new, y, test_size=0.333333333333,
